...
Version: 1
Task: Write a C function to return the index of FIRST occurrence of 
...
int main(){
	...
	//Searching for the First Occurrence of this number:
	int INDEX = FirstOccurrence(Number, SIZE, y);
