...
u8 InsertAfterANODE(u8 CopyData, u8 SearchData){
...
int main(){
	...
	printf("Please enter the value you want to insert a node after: ");
	scanf("%d", &searchData);
	printf("Please enter the value of the new node: ");
	scanf("%d", &nodeData);
	u8 check = InsertAfterANODE(nodeData, searchData);
	if(check == 1){
		Display();
	}
	else{
