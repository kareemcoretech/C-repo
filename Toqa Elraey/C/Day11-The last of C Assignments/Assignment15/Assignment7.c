...
Version: 1
Task7/8/9: Write a C function to insert a node in an empty circular 
linked list.
Write a C function to insert a node at end of a circular linked 
list.
Write a C function to create a circular linked list.
Date: 4/1/2022
*/
